...
## Domain Description
This is a Capstone Database Project for the **Real Estate** domain. It simulates a real-world enterprise database system, designed and implemented using Microsoft SQL Server to ensure data integrity, security, and efficient querying.

## Features Implemented
- Property listings and status tracking
- Client management (Buyers/Sellers)
- Transaction recording
- Automated status updates on sale

## Database Design Approach
Normalized to 3NF. Manages complex entity relationships between properties and multiple client roles.
