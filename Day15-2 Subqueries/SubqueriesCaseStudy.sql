...
Use a practice database because this script recreates the demo Employees and
Departments tables.
*/
...
INSERT INTO dbo.Employees (EmpID, FirstName, LastName, DeptID, Salary)
VALUES
...
/* T10: Retrieve employees whose salary ranks within the top 2 in their department */
SELECT
    E.EmpID,
    E.FirstName,
    E.LastName,
...
/* T10 alternative using DENSE_RANK */
...
WHERE SalaryRank <= 2
ORDER BY DeptName, SalaryRank, Salary DESC;
