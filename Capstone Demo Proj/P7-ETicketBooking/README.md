# E-Ticket Booking System Database

## Domain Description
This is a Capstone Database Project for the **Entertainment and Ticketing** domain. It simulates a real-world enterprise database system, designed and implemented using Microsoft SQL Server to ensure data integrity, security, and efficient querying.

## Features Implemented
- Show scheduling and seat availability
- User registration
- Ticket booking and issuance
- Automated seat deduction via triggers

## Database Design Approach
Normalized to 3NF. Maps Users to Shows through Tickets to handle capacity.
