...
## Domain Description
This is a Capstone Database Project for the **Events and Ticketing** domain. It simulates a real-world enterprise database system, designed and implemented using Microsoft SQL Server to ensure data integrity, security, and efficient querying.

## Features Implemented
- Event creation and capacity tracking
- Participant registration
- Booking management
- Capacity checking functions

## Database Design Approach
Normalized to 3NF. Uses junction tables (Bookings) to map Participants to Events.
